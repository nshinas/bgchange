  ...
  return (
    <>
      ...
      <div className='w-full h-screen duration-200' style={{backgroundColor : color}}> 
           <h1 className='text-3xl text-center text-white font-semibold'>WELCOME TO BACKGROUND CHANGER</h1>
           <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
              <div className='flex flex-wrap gap-5 shadow-lg bg-white px-3 py-2 rounded-3xl'>
                 {/* // this onclick function expects a function that's why we are passing function there  */}
                ...
                <button onClick={() => setColor("gray")} className='outline-none px-4 py-1 rounded-full text-black' style={{backgroundColor:"gray"}}>Gray</button>
